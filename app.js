(() => {
  ...
  const groupAvatarUrl = key => {
    ...
    return window.RESENHA_GROUP_AVATARS?.[normalized] || assetUrl(`assets/group-avatars/${normalized}.png?v=beta126`);
  };
  ...
  const App = {
    ...
    bindGlobal() {
      ...
      document.addEventListener("error", event => {
        ...
        image.src = window.RESENHA_GROUP_AVATARS?.["badge-01"] || assetUrl("assets/group-avatars/badge-01.png?v=beta126");
      }, true);
    },
