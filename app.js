(() => {
  ...
  const APP_RELEASE = Object.freeze({ channel: "beta", version: "Beta 1.0", build: 126, database: 124, edge: 104 });
  ...
  const groupAvatarUrl = key => {
    ...
    return window.RESENHA_GROUP_AVATARS?.[normalized] || assetUrl(`assets/group-avatars/${normalized}.png?v=beta126r1`);
  };
  ...
  const App = {
    ...
    bindGlobal() {
      ...
      document.addEventListener("error", event => {
        ...
        image.src = window.RESENHA_GROUP_AVATARS?.["badge-01"] || assetUrl("assets/group-avatars/badge-01.png?v=beta126r1");
      }, true);
    },
